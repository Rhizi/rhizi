...
define('view/graph_view',
       ['d3',  'jquery', 'underscore', 'Bacon', 'consts', 'util', 'view/selection', 'model/diff', 'view/item_info', 'view/bubble', 'model/types', 'view/layouts', 'view/filter', 'image_cache'],
